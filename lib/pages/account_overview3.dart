...
List<Map> _barListDetailsList = [
  {"text": "Superm\narket", "barValue": 0.8},
  {"text": "Travel", "barValue": 0.7},
  {"text": "Educat\nion", "barValue": 0.4},
  {"text": "Tax", "barValue": 0.7},
  {"text": "Transpo\nrtation", "barValue": 0.9},
  {"text": "Shopp\ning", "barValue": 0.5}
];

class AccountOverview3 extends StatefulWidget {
  const AccountOverview3({Key? key}) : super(key: key);

  @override
  State<AccountOverview3> createState() => _AccountOverview3();
}

class _AccountOverview3 extends State<AccountOverview3> {
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child: CustomPaint(
                            size: Size(26.w, 26.h),
                            painter: ModalSheetIconPainter3(),
                          )),
                        ),
                      ),
                      Padding(
...
class OverviewPage3ListItem extends StatelessWidget {
  final Color dotColor;
  final String balanceTypeText;
  final String date;
  final String money;
  const OverviewPage3ListItem({
    Key? key,
...
class BookmarkLogoPainter3 extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
...
class MobileDataPainter3 extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    Path path_0 = Path();
...
class MenuIconPainter3 extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    Path path_0 = Path();
...
class PieChartIconPainter3 extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    Path path_0 = Path();
...
class ModalSheetIconPainter3 extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    Path path_0 = Path();
