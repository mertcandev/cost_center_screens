              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: Utils.kCircularButtonBorderColor, width: 0.5)),
                  child: const Icon(
                      ...
                      itemBuilder: (context, index) {
                        return SlidableListItem(
                          ...
                          categoryDetail: _transactionListDetails[index]
                              ["categoryDetail"],
                          listViewCardBoldMoney: _transactionListDetails[index]
                              ["listViewCardBoldMoney"],
                          listViewCardLightMoney: _transactionListDetails[index]
                              ["listViewCardBoldMoney"],
