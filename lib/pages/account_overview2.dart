...
List<Map> _barListDetailsList = [
  {"text": "Jan 22", "barValue": 0.8},
  {"text": "Feb 22", "barValue": 0.7},
  {"text": "Mar 22", "barValue": 0.4},
  {"text": "Apr 22", "barValue": 0.7},
  {"text": "May 22", "barValue": 0.9},
  {"text": "June 22", "barValue": 0.5}
];

class AccountOverview2 extends StatefulWidget {
  const AccountOverview2({Key? key}) : super(key: key);

  @override
  State<AccountOverview2> createState() => _AccountOverview2();
}

class _AccountOverview2 extends State<AccountOverview2> {
...
class OverviewPage2ListItem extends StatelessWidget {
  final Color dotColor;
  final String balanceTypeText;
  final String date;
  final String money;
  const OverviewPage2ListItem({
    Key? key,
...
class BookmarkLogoPainter2 extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
